  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-light my_navbar">
      <div className="container px-4 px-lg-5">
        <a className="navbar-brand" href="#!">Psicoarte espacio</a>
        <button
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a className="dropdown-item" href="#!">Nuevas Clases</a></li>
              </ul>
            </li>
          </ul>
    ...
    {/* <!-- Header--> */}
    <header className="mi-header py-5">
      <div className="container px-4 px-lg-5 my-5">
        <div className="text-center text-secondary">
          <h1 className="display-4 fw-bolder">Nuestros espacios</h1>
          <p className="lead fw-normal text-secondary-50 mb-0">
            El arte es una expresión necesaria del alma
          </p>
        </div>
      </div>
    </header>
            ...
            <div className="card h-100">
              ...
              <div className="card-body p-4">
                <div className="text-center">
                  {/* <!-- Product name--> */}
                  <h5 className="fw-bolder">Clase especial</h5>
                  {/* <!-- Product reviews--> */}
                  <div
